	...
	public void addNoleggio(Noleggio p) throws Exception {
		if(p != null) {
			...
			if(postiRichiesti <= postiDisponibili) {
				...
				throw new Exception("Veicoli disponibili (" + postiDisponibili + ") non sufficienti per i veicoli richiesti (" + postiRichiesti + ").");
			}
		}
		else {
			throw new IllegalArgumentException("Noleggio non può essere null");
		}
	}
}
